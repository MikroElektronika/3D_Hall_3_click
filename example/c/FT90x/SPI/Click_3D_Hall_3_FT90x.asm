...
LDK.L	R0, #0
CALL	_mikrobus_gpioInit+0
;Click_3D_Hall_3_FT90x.c,38 :: 		mikrobus_spiInit( _MIKROBUS1, &_C3DHALL3_SPI_CFG[0] );
LDK.L	R1, #__C3DHALL3_SPI_CFG+0
LDK.L	R0, #0
...
;Click_3D_Hall_3_FT90x.c,49 :: 		c3dhall3_spiDriverInit( (T_C3DHALL3_P)&_MIKROBUS1_GPIO, (T_C3DHALL3_P)&_MIKROBUS1_SPI );
