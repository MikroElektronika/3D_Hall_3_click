...
MOVW	R0, #lo_addr(?lstr1_Click_3D_Hall_3_CEC+0)
MOVT	R0, #hi_addr(?lstr1_Click_3D_Hall_3_CEC+0)
MOVS	R1, #2
...
MOVW	R0, #lo_addr(?lstr2_Click_3D_Hall_3_CEC+0)
MOVT	R0, #hi_addr(?lstr2_Click_3D_Hall_3_CEC+0)
MOVS	R1, #2
BL	_mikrobus_logWrite+0
...
MOVW	R0, #lo_addr(?lstr3_Click_3D_Hall_3_CEC+0)
MOVT	R0, #hi_addr(?lstr3_Click_3D_Hall_3_CEC+0)
MOVS	R1, #1
BL	_mikrobus_logWrite+0
...
MOVW	R0, #lo_addr(?lstr4_Click_3D_Hall_3_CEC+0)
MOVT	R0, #hi_addr(?lstr4_Click_3D_Hall_3_CEC+0)
MOVS	R1, #1
BL	_mikrobus_logWrite+0
...
MOVW	R0, #lo_addr(?lstr5_Click_3D_Hall_3_CEC+0)
MOVT	R0, #hi_addr(?lstr5_Click_3D_Hall_3_CEC+0)
MOVS	R1, #1
BL	_mikrobus_logWrite+0
