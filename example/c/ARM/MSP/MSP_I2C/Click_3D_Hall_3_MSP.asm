...
MOVS	R0, #0
BL	_mikrobus_gpioInit+0
;Click_3D_Hall_3_MSP.c,39 :: 		mikrobus_i2cInit( _MIKROBUS1, &_C3DHALL3_I2C_CFG[0] );
...
SUB	SP, SP, #4
STR	LR, [SP, #0]
;Click_3D_Hall_3_MSP.c,50 :: 		c3dhall3_i2cDriverInit( (T_C3DHALL3_P)&_MIKROBUS1_GPIO, (T_C3DHALL3_P)&_MIKROBUS1_I2C, 0x1E );
MOVS	R2, #30
