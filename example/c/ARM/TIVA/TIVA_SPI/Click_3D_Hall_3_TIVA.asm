...
MOVS	R0, #0
BL	_mikrobus_gpioInit+0
;Click_3D_Hall_3_TIVA.c,38 :: 		mikrobus_spiInit( _MIKROBUS1, &_C3DHALL3_SPI_CFG[0] );
...
SUB	SP, SP, #4
STR	LR, [SP, #0]
;Click_3D_Hall_3_TIVA.c,49 :: 		c3dhall3_spiDriverInit( (T_C3DHALL3_P)&_MIKROBUS1_GPIO, (T_C3DHALL3_P)&_MIKROBUS1_SPI );
